...
<script type = "text/javascript">
	...
	function init() {
		...
		CN_TRIANGLE_NO_COLOUR_SHADER_PROGRAM = gl.createProgram();
		gl.attachShader(CN_TRIANGLE_NO_COLOUR_SHADER_PROGRAM, cn_gl_get_shader("CN_TRIANGLE_NO_COLOUR_FRAGMENT"));
		gl.attachShader(CN_TRIANGLE_NO_COLOUR_SHADER_PROGRAM, cn_gl_get_shader("CN_TRIANGLE_NO_COLOUR_VERTEX"));
		gl.linkProgram(CN_TRIANGLE_NO_COLOUR_SHADER_PROGRAM);

		if (!gl.getProgramParameter(CN_TRIANGLE_SHADER_PROGRAM, gl.LINK_STATUS)) {
			console.log("Unable to init shader program");
		}
		if (!gl.getProgramParameter(CN_TRIANGLE_NO_COLOUR_SHADER_PROGRAM, gl.LINK_STATUS)) {
			console.log("Unable to init shader program");
		}
		...
		cube_object.set_program(CN_TRIANGLE_NO_COLOUR_SHADER_PROGRAM);
	...
	function draw() {
		...
		gl.useProgram(CN_TRIANGLE_NO_COLOUR_SHADER_PROGRAM);
		camera.push_matrix_to_shader(CN_TRIANGLE_NO_COLOUR_SHADER_PROGRAM, "uPMatrix", "uMVMatrix");
...
<html>
	...
	<body onload = "cn_gl_init_gl('glCanvas', init)">
		<?php
			...
			cn_gl_load_fragment_shader("CN_TRIANGLE_NO_COLOUR_FRAGMENT", "shader/CN_SHAPES/triangle_no_colour.frag");
			cn_gl_load_vertex_shader  ("CN_TRIANGLE_NO_COLOUR_VERTEX", "shader/CN_SHAPES/triangle_no_colour.vert");
		?>
	</body>
</html>
